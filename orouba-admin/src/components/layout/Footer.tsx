...
export default function Footer({ settings, socials, brands }: FooterProps) {
  ...
  const address = localizedSetting(
    settings,
    currentLocale,
    ["location", "address"],
    locale === "ar"
      ? "مدينة العبور، بلوك ١٢٠٠٨، قسم ٥، القاهرة، ص.ب: العبور ٤٢، مدينة العبور، مصر"
      : "Obour city, Block 12008, section 5, Cairo, P.O.Box : El Obour 42 ,El Obour City, Egypt."
  );
            ...
            <div className={`flex flex-col items-start ${locale === "ar" ? "text-right" : "text-left"}`}>
              ...
              <ul className="space-y-5 text-white flex flex-col w-full items-start">
                ...
                <li className="flex items-center gap-3 w-full mt-2 mb-6 justify-start">
                  ...
                  <a href={`mailto:${email}`} className="text-sm hover:text-orouba-yellow transition-colors">{email}</a>
                </li>
                    ...
                    >
                      <ul className="space-y-6 pt-6 text-white flex flex-col w-full items-start px-10">
                        ...
                        <li className="flex items-center gap-4 w-full mb-6 justify-start">
                          ...
                          <a href={`mailto:${email}`} className="text-lg hover:text-orouba-yellow transition-colors">{email}</a>
                        </li>
